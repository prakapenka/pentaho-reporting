...
public class BigDataDataSourcePlugin implements DataSourcePlugin
{
                                 ...
                                 final DataFactoryChangeRecorder changeRecorder)
  {
    ...
    try
    {
      ...
      {
        final BigDataQueryTransformationProducer query = bigDataDataFactory.getQuery();
        if (query == null)
        {
          transMeta = loadTransformation(cls);
        }
      ...
      if (dlg.open() != null)
      {
        ...
        retval.setQuery(new BigDataQueryTransformationProducer(new String[0], new ParameterMapping[0], id, rawData));
        return retval;
      }
