...
package org.pentaho.reporting.engine.classic.extensions.datasources.mongodb.parser;
...
import org.pentaho.reporting.engine.classic.extensions.datasources.mongodb.MongoDbDataFactoryModule;
 ...
 */
public class MongoDbDataSourceXmlFactoryModule implements XmlFactoryModule
{
  ...
  public MongoDbDataSourceXmlFactoryModule()
  {
  }
  ...
  public int getDocumentSupport(final XmlDocumentInfo documentInfo)
  {
    ...
    if (rootNamespace != null && rootNamespace.length() > 0)
    {
      ...
      else if ("mongodb-datasource".equals(documentInfo.getRootElement()))
      {
  ...
  {
    return new KettleDataSourceReadHandler(new MongoDbDataFactory());
  }
}