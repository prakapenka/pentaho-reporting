 ...
 */
public class MongoDbDataFactoryWriteHandler implements DataFactoryWriteHandler
{
  ...
  public MongoDbDataFactoryWriteHandler()
  {
  }
      ...
      throws IOException
  {
    ...
    coreAttrs.setAttribute(NAMESPACE, "password", fileProducer.getPassword());
      ...
      throws IOException
  {
    ...
    coreAttrs.setAttribute(NAMESPACE, "password", repositoryProducer.getPassword());
